    ...
    for idx, page in enumerate(pdf.pages):
        ...
        try:
            ...
            rename_map = {
                ...
                "Horário de Ocorrência": "Hora",
                "Horario de Ocorrencia": "Hora",

                "Estação": "Código Estação",
                "Estacao": "Código Estação",

                "Valor Diário": "Valor Diário",
                "Data": "Data"
            }
            ...
            df["Tipo de Rede"] = "Automático"

            df["Tipo de Monitoramento"] = "CETESB"

            df["Tipo"] = "Dados Diários"

            # =================================================
            # METADADOS
            # =================================================

            df["Código Estação"] = station_code

            df["Nome Estação"] = station_name

            df["Nome Parâmetro"] = pollutant

            df["Unidade de Medida"] = unidade_medida
            ...
            # adiciona outras colunas restantes
            remaining_cols = [
