...
# VERSÃO INCIAL - Funciona para 01 estação (63)
# import os
# from io import StringIO
...
# OUTPUT_DIR = "../cipc_data/cetesb"

# os.makedirs(OUTPUT_DIR, exist_ok=True)

# ESTACAO = 63

# # Dowload de todas as estações 
...
# print("STATUS AUTH:", r_auth.status_code)
# print("URL FINAL:", r_auth.url)

# print("\nHISTORY:")
# for h in r_auth.history:
...
# print("STATUS HOME:", r.status_code)

# # salva html para debug
# with open("qualar.html", "w", encoding="utf-8") as f:
#     f.write(r.text)

# print("HTML salvo: qualar.html")

# # =========================================================
# # DEBUG DOS SELECTS
# # =========================================================

# print("\nLendo selects do HTML...")
...
#     print("\nSTATUS CONSULTA:", response.status_code)

#     # salva html de retorno
#     html_debug = (
#         f"debug_{nome_pol}.html"
#     )
...
#     print("Número de tabelas:", len(tabelas))
...
#             # ignora tabelas pequenas
#             if df.shape[0] < 5:
#                 continue

#             # ignora "Digite os Dados"
#             texto_df = df.astype(str).to_string()
#             if (
#                 "Login:" in texto_df
#                 or "Senha:" in texto_df
...
#             if "Digite os Dados" in texto_df:
#                 continue

#             encontrou = True

#             print("\nTabela válida encontrada:")
#             print(df.head())
